...
// APIClient manages communication with the JumpCloud APIs API v2.0
...
type APIClient struct {
	...
	WorkdayImportApi	*WorkdayImportApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.WorkdayImportApi = (*WorkdayImportApiService)(&c.common)
...
func parameterToString(obj interface{}, collectionFormat string) string {
	...
	if reflect.TypeOf(obj).Kind() == reflect.Slice {
		parameter := strings.ReplaceAll(fmt.Sprint(obj), "\\ ", "[escaped_space]")
		return strings.Trim(strings.ReplaceAll(strings.Replace(parameter, " ", delimiter, -1), "[escaped_space]", " "), "[]")
	}
